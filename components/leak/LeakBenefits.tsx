...
import { LEAK_BENEFITS } from "@/lib/leak-data";

export function LeakBenefits() {
  return (
    <section className="bg-clear py-14 lg:py-16">
      <div className="container-skyve grid gap-8 sm:grid-cols-2 lg:grid-cols-5 lg:divide-x lg:divide-mist">
        {LEAK_BENEFITS.map((b) => (
