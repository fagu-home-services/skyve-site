...
import { IP_HERO } from "@/lib/investors-data";
      ...
      <div className="container-skyve grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-center">
        <div>
          ...
          <div className="mt-7 flex flex-wrap gap-3">
            <a href="#express" className="inline-flex items-center gap-2 rounded-lg bg-horizon-deep px-6 py-3.5 text-sm font-semibold text-clear shadow-card transition-colors hover:bg-horizon">
              Express Interest
            </a>
            <a href="#" className="inline-flex items-center gap-2 rounded-lg border border-ridge/30 px-6 py-3.5 text-sm font-semibold text-ridge transition-colors hover:border-ridge hover:bg-mist-soft">
              <Download className="h-4 w-4" /> Download Investor Deck
            </a>
          </div>
        </div>

        <div className="relative">
          <Photo src={h.image} alt="Investors program" className="aspect-[16/10] rounded-2xl shadow-elevated" />
          <div className="mt-4 rounded-2xl bg-horizon-deep p-6 text-clear shadow-elevated lg:absolute lg:bottom-4 lg:right-4 lg:mt-0 lg:w-[90%]">
