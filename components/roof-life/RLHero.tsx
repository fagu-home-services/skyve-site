...
import { RL_HERO, RL_STEPS } from "@/lib/roof-life-data";

export function RLHero() {
  const h = RL_HERO;
  return (
    <>
      <section className="bg-clear pb-8 pt-2">
        <div className="container-skyve grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-center">
          ...
          <div className="relative">
            <Photo src={h.image} alt="Roof life expectancy calculator" className="aspect-[16/10] rounded-2xl shadow-elevated" />
