...
import { CP_HERO, CP_BENEFITS } from "@/lib/contractors-data";
    ...
    <>
      <section className="bg-clear pb-8 pt-2">
        <div className="container-skyve grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-center">
          ...
          <div className="relative">
            <Photo src={h.image} alt="Contractors program" className="aspect-[16/10] rounded-2xl shadow-elevated" />
      ...
      <section className="bg-mist-soft/40 py-8">
        <div className="container-skyve">
          <h2 className="text-center text-xs font-bold uppercase tracking-wider text-ink-50">Contractor Partner Benefits</h2>
          <div className="mt-4 grid grid-cols-2 gap-4 sm:grid-cols-4 lg:grid-cols-7">
            {CP_BENEFITS.map((b) => (
              <div key={b.title} className="rounded-xl border border-mist bg-clear p-4 text-center shadow-card">
                ...
                <p className="mt-2.5 text-[11px] font-bold text-horizon">{b.title}</p>
