...
import { MC_HERO, MC_STEPS } from "@/lib/material-compare-data";
      ...
      <section className="bg-clear pb-8 pt-2">
        <div className="container-skyve grid gap-8 lg:grid-cols-[1fr_1.05fr] lg:items-center">
          ...
          <div className="relative">
            <Photo src={h.image} alt="Roofing material comparison tool" className="aspect-[16/10] rounded-2xl shadow-elevated" />
