...
import { LUXURY_SHINGLES } from "@/lib/material-pages";

const data = LUXURY_SHINGLES;

export const metadata: Metadata = {
  title: "Luxury Shingles",
  description:
    "Unmatched elegance, uncompromising protection. Skyve installs the industry's finest luxury shingles — premium materials, designer colors, 130 MPH+ wind resistance, and lifetime warranties.",
};

export default function LuxuryShinglesPage() {
  return (
    <>
      <SiteHeader />
