...
import { STANDING_SEAM } from "@/lib/material-pages";

const data = STANDING_SEAM;

export const metadata: Metadata = {
  title: "Standing Seam Roofing",
  description:
    "Timeless strength, modern performance. Skyve installs premium standing seam metal roofing with concealed fasteners, 140+ MPH wind resistance, and 50+ year lifespan.",
};
