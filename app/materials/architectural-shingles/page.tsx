...
import { ARCHITECTURAL_SHINGLES } from "@/lib/material-pages";

const data = ARCHITECTURAL_SHINGLES;

export const metadata: Metadata = {
  title: "Architectural Shingles",
  description:
    "Elevated beauty, superior protection. Skyve installs premium architectural (dimensional) shingles with high wind and impact resistance, longer lifespan, and strong warranties.",
};
