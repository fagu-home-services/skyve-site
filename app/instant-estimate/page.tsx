...
/* QR-code / print landing page. Reached via a printed QR that points at
   www.skyvewa.com/instant-estimate. Self-contained (no site nav), the form
   captures the lead directly and posts to /api/lead → the configured
   destination (Google Sheet webhook / Verascor). noindex: it's a paid/print
   landing, not organic search. */
export const metadata: Metadata = {
  title: { absolute: "Get a Free Roof Estimate | Skyve Roofing & Exteriors" },
  description:
